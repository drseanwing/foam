...
```
Case vignette â†’ Clinical question â†’ Evidence/Discussion â†’ Pearl
     â†“
Case evolves (new data) â†’ Next question â†’ Evidence â†’ Pearl
     â†“
...
â–¡ Format matches requested type
â–¡ All claims cited
â–¡ Uncertainty explicitly stated
â–¡ Clinical pearl placeholders marked
â–¡ Expert input prompts included
â–¡ Peer reviewer attribution space
â–¡ Bottom line summary present
â–¡ References with PMIDs
â–¡ FOAMed cross-references included
